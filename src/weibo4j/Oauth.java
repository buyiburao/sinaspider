...
public class Oauth extends Weibo{
	...
	public String authorize(String response_type) throws WeiboException {
    	System.out.println(WeiboConfig.getValue("client_ID").trim());
		System.out.println(WeiboConfig.getValue("redirect_URI").trim());
		return WeiboConfig.getValue("authorizeURL").trim() + "?client_id="
				...
				+ "&response_type=" + response_type+"&display="+"apponweibo";
	}
}
