...
public class Timeline extends Weibo{
	...
	public StatusWapper getHomeTimeline(int page,int count) throws WeiboException{
      return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL")+"statuses/home_timeline.json",new PostParameter[]{
	...
	public StatusWapper getUserTimelineByUid(String uid, int page,
         int count) throws WeiboException {
      return Status.constructWapperStatus(client.get(
                  WeiboConfig.getValue("baseURL")  + "statuses/user_timeline.json",
                  new PostParameter[] {
                        new PostParameter("uid", uid),
	...
	public StatusWapper getRepostTimeline(String id,int count,int page) throws WeiboException {
		return Status.constructWapperStatus(client.get(
				WeiboConfig.getValue("baseURL")
						+ "statuses/repost_timeline.json",
				new PostParameter[] { new PostParameter("id", id), 
	...
	public StatusWapper getBilateralTimeline(int page,int count) throws WeiboException{
      return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL")+"statuses/bilateral_timeline.json",new PostParameter[]{
         new PostParameter("page", page),
         new PostParameter("count",count)
      }));
   }
